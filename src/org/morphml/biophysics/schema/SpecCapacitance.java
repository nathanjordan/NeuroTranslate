...
@XmlType(name = "SpecCapacitance", propOrder = {
    "parameters",
    "variableParameters",
    "capacitanceVariableParameter"
})
public class SpecCapacitance {
    ...
    protected List<VariableParameter> capacitanceVariableParameter;
    ...
    /**
     * Gets the value of the capacitanceVariableParameter property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the capacitanceVariableParameter property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCapacitanceVariableParameter().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VariableParameter> getCapacitanceVariableParameter() {
        if (capacitanceVariableParameter == null) {
            capacitanceVariableParameter = new ArrayList<VariableParameter>();
        }
        return this.capacitanceVariableParameter;
    }
