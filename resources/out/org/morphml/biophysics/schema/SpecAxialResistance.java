...
public class SpecAxialResistance {
    ...
    protected List<VariableParameter> axialVariableParameter;
    ...
    /**
     * Gets the value of the axialVariableParameter property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the axialVariableParameter property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAxialVariableParameter().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VariableParameter> getAxialVariableParameter() {
        if (axialVariableParameter == null) {
            axialVariableParameter = new ArrayList<VariableParameter>();
        }
        return this.axialVariableParameter;
    }
